...
// nucleus::tile_scheduler::tile_types::TileQuad example_tile_quad_for(const tile::Id& id, unsigned n_children = 4, NetworkInfo::Status status =
// NetworkInfo::Status::Good)
// {
...
//             check_persited_tiles(scheduler, std::vector { tile::Id { 0, { 0, 0 } }, tile::Id { 1, { 1, 1 } }, tile::Id { 2, { 2, 2 } }, tile::Id { 3, { 0, 0
//             } }, tile::Id { 4, { 0, 1 } } }); scheduler->set_ram_quad_limit(3); scheduler->update_camera(nucleus::camera::stored_positions::stephansdom());
//             scheduler->update_gpu_quads();
//             scheduler->purge_ram_cache();
//             CHECK(scheduler->ram_cache().n_cached_objects() == 3);
//             check_persited_tiles(scheduler, std::vector { tile::Id { 0, { 0, 0 } }, tile::Id { 1, { 1, 1 } }, tile::Id { 2, { 2, 2 } } });
